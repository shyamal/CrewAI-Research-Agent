...
set_target_properties(AWS::aws-crt-cpp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libaws-crt-cpp.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libaws-crt-cpp.dylib"
  )

list(APPEND _cmake_import_check_targets AWS::aws-crt-cpp )
list(APPEND _cmake_import_check_files_for_AWS::aws-crt-cpp "${_IMPORT_PREFIX}/lib/libaws-crt-cpp.dylib" )
